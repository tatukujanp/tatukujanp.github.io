...
document.addEventListener("keypress", function(event){
    ...
    document.addEventListener("keypress", function(event){
        ...
        document.getElementById("myBtn").addEventListener("click", function(){
            ...
            document.querySelector(".tbl-brutto-v").innerHTML = kassavirta.toFixed(2) * 12 + " €";

            document.querySelector(".tbl-verot").innerHTML = verot.toFixed(2) + " €";
            document.querySelector(".tbl-verot-v").innerHTML = verot.toFixed(2) * 12 + " €";

            document.querySelector(".tbl-netto").innerHTML = (kassavirta - verot).toFixed(2) + " €";
            document.querySelector(".tbl-netto-v").innerHTML = (kassavirta - verot).toFixed(2) * 12 + " €";
